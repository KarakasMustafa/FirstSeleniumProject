...
//  username, password, firstname, lastname, result
    ...
    public void loginTest(String username, String password, String firstName, String lastName, String result){
        ...
        if(username.equals("username")){
            throw new SkipException("Skipped the first Row!");
        }else {
    ...
    public static void main(String[] args) {
        ...
        // when we retrieve data from map, we don't need to specify index, we specify key name
        // keys must be unique, keys are represented by column names
